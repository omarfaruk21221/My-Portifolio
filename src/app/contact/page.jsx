...
import { FaMapMarkerAlt, FaFacebook, FaLinkedin, FaWhatsapp, FaGithub } from "react-icons/fa";
        ...
        <section className="font-display  bg-base-100 dark:bg-base-300 min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-6xl mx-auto mt-20">
                ...
                <main className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-base-content mb-8 border-b border-base-content/10 pb-4">Contact Info</h3>
                        <ul className="space-y-10">
                            ...
                            <li className="flex items-center space-x-6 group">
                                ...
                                <div>
                                    <h3 className="font-bold text-base-content text-xl mb-1">Address</h3>
                                    <p className="text-base-content/70 text-lg">Mirpur, Dhaka, Bangladesh</p>
                                </div>
                            </li>

                            {/* Social Media Icons (Only Icons) */}
                            <li className="pt-4">
                                <h3 className="font-bold text-base-content text-xl mb-6">Connect With Me</h3>
